...
class Product(models.Model):
    ...
    # Добавлен параметр related_name='products'
    ...
    views = models.IntegerField(default=0, verbose_name="Кількість переглядів") # Счетчик просмотров
    ...
    def __str__(self):
        return f"{self.name} (Переглядів: {self.views})"

    # Метод генерации ссылки на детальную страницу товара
    def get_absolute_url(self):
